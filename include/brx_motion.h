...
public:
    ...
    virtual void set_input(brx_motion_video_capture const *video_capture) = 0;
...
{
public:
    virtual void set_input(brx_motion_video_detector const*video_detector, uint32_t face_index, uint32_t pose_index) = 0;

    virtual void set_input(brx_motion_animation_instance const *animation_instance) = 0;
