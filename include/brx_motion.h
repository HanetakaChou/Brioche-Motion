...
extern "C" brx_motion_skeleton *brx_motion_create_skeleton(uint32_t skeleton_joint_count, char const *const *skeleton_joint_names, uint32_t const *skeleton_joint_parent_indices, brx_motion_rigid_transform const *skeleton_bind_pose_joint_local_space_transforms, uint32_t const vrm_joint_indices[BRX_MOTION_VRM_SKELETON_JOINT_NAME_COUNT]);
...
public:
    ...
    // local space
    virtual brx_motion_rigid_transform const *get_skeleton_bind_pose_joint_transforms() const = 0;
};

// how to use data from mediapipe pose landmarker
// referenced VRMViewMeister
// https://github.com/nishlumi/vrmviewmeister/blob/main/src/js/model/childman.js#L464
//
//---newcode---
// unitylist = [];
...
//---end---
//
// notice "UnityVector3(0, 0, 0)" // no Aim IK involved // only Reach IK
//
// Animator.SetIKPosition
// https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Animator.SetIKPosition.html
//
// Root Motion | Full Body Biped IK
...
public:
    ...
    virtual brx_motion_rigid_transform const *get_skeleton_animation_joint_transforms() const = 0;
};
