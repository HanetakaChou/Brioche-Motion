...
public:
	inline brx_motion_animation_animation_instance(brx_motion_animation_animation *animation);
...
class brx_motion_animation_skeleton_instance final : public brx_motion_skeleton_instance
{
	...
	bool m_input_continuous;

public:
	inline brx_motion_animation_skeleton_instance(brx_motion_animation_skeleton *skeleton);
	inline ~brx_motion_animation_skeleton_instance();
	inline void init();
	inline void uninit();

private:
	void set_input(brx_motion_video_detector const *video_detector, uint32_t face_index, uint32_t pose_index) override;
	void set_input(brx_motion_animation_instance const *animation_instance) override;
	void step() override;
	...
	inline void ragdoll(mcrt_vector<DirectX::XMFLOAT4X4> &animation_skeleton_animation_pose_model_space, float physics_delta_time);
