...
brx_motion_opencv_video_capture::brx_motion_opencv_video_capture() : m_type(BRX_MOTION_VIDEO_CAPTURE_TYPE_UNKNOWN), m_tick_count_per_second(0U), m_tick_count_per_frame(0U), m_tick_count_previous_frame(0U), m_width(0U), m_height(0U), m_fps(0U)
{
}
