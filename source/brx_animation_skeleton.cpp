...
brx_animation_skeleton::brx_animation_skeleton(mcrt_vector<mcrt_string> &&joint_names, mcrt_vector<uint32_t> &&joint_parent_indices, mcrt_vector<brx_motion_skeleton_joint_transform> &&bind_pose_local_space) : m_joint_names(std::move(joint_names)), m_joint_parent_indices(std::move(joint_parent_indices)), m_bind_pose_local_space(std::move(bind_pose_local_space))
{
}
...
brx_motion_skeleton_joint_transform brx_animation_skeleton::get_bind_pose_joint_transform_local_space(uint32_t joint_index) const
{
