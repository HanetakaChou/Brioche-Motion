...
class brx_animation_skeleton
{
    ...
    mcrt_vector<brx_motion_rigid_transform> m_bind_pose_local_space;

public:
    brx_animation_skeleton(mcrt_vector<mcrt_string> &&joint_names, mcrt_vector<uint32_t> &&joint_parent_indices, mcrt_vector<brx_motion_rigid_transform> &&bind_pose_local_space);
