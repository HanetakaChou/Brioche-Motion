...
class brx_motion_media_pipe_video_detector final : public brx_motion_video_detector
{
	...
	mcrt_vector<std::array<DirectX::XMFLOAT3, 16>> m_poses_skeleton_joint_translations_model_space;
	mcrt_vector<std::array<bool, 16>> m_poses_skeleton_joint_translations_model_space_valid;
...
private:
	...
	void set_input(brx_motion_video_capture const *video_capture) override;
	void step() override;
