...
#include "brx_motion_biped_skeleton.h"
#include "../../McRT-Malloc/include/mcrt_malloc.h"
#include "../../McRT-Malloc/include/mcrt_unordered_map.h"
#include <cassert>
#include <new>

extern "C" brx_motion_skeleton *brx_motion_create_skeleton(uint32_t skeleton_joint_count, char const *const *skeleton_joint_names, uint32_t const *skeleton_joint_parent_indices, brx_motion_rigid_transform const *skeleton_bind_pose_joint_transforms, uint32_t const vrm_skeleton_joint_indices[BRX_MOTION_VRM_SKELETON_JOINT_NAME_COUNT])
{
    void *new_unwrapped_skeleton_base = mcrt_malloc(sizeof(brx_motion_biped_skeleton), alignof(brx_motion_biped_skeleton));
    assert(NULL != new_unwrapped_skeleton_base);

    brx_motion_biped_skeleton *new_unwrapped_skeleton = new (new_unwrapped_skeleton_base) brx_motion_biped_skeleton{};
...
extern "C" void brx_motion_destory_skeleton(brx_motion_skeleton *wrapped_skeleton)
{
    ...
    brx_motion_biped_skeleton *delete_unwrapped_skeleton = static_cast<brx_motion_biped_skeleton *>(wrapped_skeleton);

    delete_unwrapped_skeleton->uninit();

    delete_unwrapped_skeleton->~brx_motion_biped_skeleton();
    mcrt_free(delete_unwrapped_skeleton);
}

brx_motion_biped_skeleton::brx_motion_biped_skeleton()
{
}
...
void brx_motion_biped_skeleton::init(uint32_t skeleton_joint_count, char const *const *skeleton_joint_names, uint32_t const *skeleton_joint_parent_indices, brx_motion_rigid_transform const *skeleton_bind_pose_joint_transforms, uint32_t const vrm_skeleton_joint_indices[BRX_MOTION_VRM_SKELETON_JOINT_NAME_COUNT])
{
    ...
    std::memcpy(&this->m_skeleton_bind_pose_joint_transforms[0], skeleton_bind_pose_joint_transforms, sizeof(brx_motion_rigid_transform) * static_cast<size_t>(skeleton_joint_count));
}

void brx_motion_biped_skeleton::uninit()
{
}

uint32_t brx_motion_biped_skeleton::get_skeleton_joint_count() const
{
    return this->m_skeleton_joint_names.size();
}

mcrt_vector<mcrt_string> const *brx_motion_biped_skeleton::get_skeleton_joint_names() const
{
    return &this->m_skeleton_joint_names;
}

int32_t const *brx_motion_biped_skeleton::get_skeleton_joint_parent_indices() const
{
    return &this->m_skeleton_joint_parent_indices[0];
}

brx_motion_rigid_transform const *brx_motion_biped_skeleton::get_skeleton_bind_pose_joint_transforms() const
{
    return &this->m_skeleton_bind_pose_joint_transforms[0];
}

extern "C" brx_motion_skeleton_animation *brx_motion_create_skeleton_animation(uint32_t skeleton_joint_count, char const *const *skeleton_joint_names, uint32_t animation_frame_rate, uint32_t animation_frame_count, brx_motion_rigid_transform const *skeleton_animation_joint_transforms)
{
    void *new_unwrapped_skeleton_animation_base = mcrt_malloc(sizeof(brx_motion_biped_skeleton_animation), alignof(brx_motion_biped_skeleton_animation));
    assert(NULL != new_unwrapped_skeleton_animation_base);

    brx_motion_biped_skeleton_animation *new_unwrapped_skeleton_animation = new (new_unwrapped_skeleton_animation_base) brx_motion_biped_skeleton_animation{};
...
extern "C" void brx_motion_destory_skeleton_animation(brx_motion_skeleton_animation *wrapped_skeleton_animation)
{
    ...
    brx_motion_biped_skeleton_animation *delete_unwrapped_skeleton_animation = static_cast<brx_motion_biped_skeleton_animation *>(wrapped_skeleton_animation);

    delete_unwrapped_skeleton_animation->uninit();

    delete_unwrapped_skeleton_animation->~brx_motion_biped_skeleton_animation();
    mcrt_free(delete_unwrapped_skeleton_animation);
}

brx_motion_biped_skeleton_animation::brx_motion_biped_skeleton_animation()
{
}
...
void brx_motion_biped_skeleton_animation::init(uint32_t skeleton_joint_count, char const *const *skeleton_joint_names, uint32_t animation_frame_rate, uint32_t animation_frame_count, brx_motion_rigid_transform const *skeleton_animation_joint_transforms)
{
    assert(this->m_skeleton_joint_names.empty());
    this->m_skeleton_joint_names.resize(static_cast<size_t>(skeleton_joint_count));
    ...
    std::memcpy(&this->m_skeleton_animation_joint_transforms[0], skeleton_animation_joint_transforms, sizeof(brx_motion_rigid_transform) * (static_cast<size_t>(skeleton_joint_count) * static_cast<size_t>(animation_frame_count)));

    this->m_animation_frame_rate = animation_frame_rate;
}

void brx_motion_biped_skeleton_animation::uninit()
{
}

uint32_t brx_motion_biped_skeleton_animation::get_skeleton_joint_count() const
{
    return static_cast<uint32_t>(this->m_skeleton_joint_names.size());
}

mcrt_vector<mcrt_string> const *brx_motion_biped_skeleton_animation::get_skeleton_joint_names() const
{
    return &this->m_skeleton_joint_names;
}

uint32_t brx_motion_biped_skeleton_animation::get_animation_frame_count() const
{
...
brx_motion_rigid_transform const *brx_motion_biped_skeleton_animation::get_skeleton_animation_joint_transforms() const
{
    return &this->m_skeleton_animation_joint_transforms[0];
}

uint32_t brx_motion_biped_skeleton_animation::get_animation_frame_rate() const
{
...
{
    void *new_unwrapped_skeleton_animation_instance_base = mcrt_malloc(sizeof(brx_motion_biped_skeleton_animation_instance), alignof(brx_motion_biped_skeleton_animation_instance));
    assert(NULL != new_unwrapped_skeleton_animation_instance_base);

    brx_motion_biped_skeleton_animation_instance *new_unwrapped_skeleton_animation_instance = new (new_unwrapped_skeleton_animation_instance_base) brx_motion_biped_skeleton_animation_instance{};
...
extern "C" void brx_motion_destory_skeleton_animation_instance(brx_motion_skeleton_animation_instance *wrapped_skeleton_animation_instance)
{
    ...
    brx_motion_biped_skeleton_animation_instance *delete_unwrapped_skeleton_animation_instance = static_cast<brx_motion_biped_skeleton_animation_instance *>(wrapped_skeleton_animation_instance);

    delete_unwrapped_skeleton_animation_instance->uninit();

    delete_unwrapped_skeleton_animation_instance->~brx_motion_biped_skeleton_animation_instance();
    mcrt_free(delete_unwrapped_skeleton_animation_instance);
}

brx_motion_biped_skeleton_animation_instance::brx_motion_biped_skeleton_animation_instance() : m_animation_frame_rate(0U), m_animation_frame_count(0U), m_skeleton_joint_count(0), m_animation_duration(0.0F), m_animation_time(0.0F)
{
}

brx_motion_biped_skeleton_animation_instance::~brx_motion_biped_skeleton_animation_instance()
{
}

void brx_motion_biped_skeleton_animation_instance::init(brx_motion_skeleton_animation *wrapped_skeleton_animation, brx_motion_skeleton *wrapped_skeleton)
{
    // Animation Retargeting

    brx_motion_biped_skeleton_animation const *const unwrapped_skeleton_animation = static_cast<brx_motion_biped_skeleton_animation *>(wrapped_skeleton_animation);

    mcrt_vector<mcrt_string> const &skeleton1_animation_track_names = *unwrapped_skeleton_animation->get_skeleton_joint_names();

    brx_motion_rigid_transform const *const skeleton1_animation_track_joint_transforms = unwrapped_skeleton_animation->get_skeleton_animation_joint_transforms();

    uint32_t const skeleton1_animation_track_count = unwrapped_skeleton_animation->get_skeleton_joint_count();

    brx_motion_biped_skeleton const *const unwrapped_skeleton = static_cast<brx_motion_biped_skeleton *>(wrapped_skeleton);
    ...
    brx_motion_rigid_transform const *const skeleton_bind_pose_joint_transforms = unwrapped_skeleton->get_skeleton_bind_pose_joint_transforms();
...
#if 0
    {
        ...
        skeleton_mapper->Initialize(skeleton1, skeleton1_bind_pose.GetJointMatrices().data(), skeleton2, skeleton2_bind_pose.GetJointMatrices().data(), false);
        ...
        for (uint32_t animation_frame_index = 0U; animation_frame_index < animation_frame_count; ++animation_frame_index)
        {
            ...
            skeleton_mapper->MapModelSpace(skeleton1_animation_pose.GetJointMatrices().data(), skeleton2_animation_pose.GetSkeleton(), skeleton2_local_space_pose.data(), skeleton2_animation_pose.GetJointMatrices().data());
    ...
    assert(0U == this->m_skeleton_joint_count);
...
void brx_motion_biped_skeleton_animation_instance::uninit()
{
}

void brx_motion_biped_skeleton_animation_instance::step(float delta_time)
{
...
brx_motion_rigid_transform const *brx_motion_biped_skeleton_animation_instance::get_skeleton_animation_joint_transforms() const
{
