...
void brx_motion_biped_skeleton::init(uint32_t skeleton_joint_count, char const *const *skeleton_joint_names, uint32_t const *skeleton_joint_parent_indices, brx_motion_skeleton_joint_transform const *skeleton_bind_pose_joint_transforms, uint32_t const vrm_skeleton_joint_indices[BRX_MOTION_VRM_SKELETON_JOINT_NAME_COUNT])
{
...
brx_motion_skeleton_joint_transform const *brx_motion_biped_skeleton::get_skeleton_bind_pose_joint_transforms() const
{
...
void brx_motion_biped_skeleton_animation::init(uint32_t skeleton_joint_count, char const *const *skeleton_joint_names, uint32_t animation_frame_rate, uint32_t animation_frame_count, brx_motion_skeleton_joint_transform const *skeleton_animation_joint_transforms)
{
    assert(this->m_skeleton_joint_names.empty());
    this->m_skeleton_joint_names.resize(static_cast<size_t>(skeleton_joint_count));
...
brx_motion_skeleton_joint_transform const *brx_motion_biped_skeleton_animation::get_skeleton_animation_joint_transforms() const
{
...
brx_motion_skeleton_joint_transform const *brx_motion_biped_skeleton_animation_instance::get_skeleton_animation_joint_transforms() const
{
